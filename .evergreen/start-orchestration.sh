...
python -m pip install -q --upgrade 'https://github.com/blink1073/mongo-orchestration/archive/PYTHON-2520.tar.gz' || python -m pip install -q --upgrade mongo-orchestration
python -m pip list
cd $DRIVERS_TOOLS
